...
public class UserTest {
	...
	public static void testInsert() {
		try {
			...
			bean.setId(1);
			bean.setFirstName("Nishil");
			bean.setLastName("Sharma");
			bean.setLogin("nishils02@gmail.com");
			bean.setPassword("nishil@1234");
			bean.setDob(sdf.parse("02-01-1998"));
			bean.setRoleId(1L);
			bean.setUnSuccessfulLogin(5);
			bean.setGender("Male");
			bean.setMobileNo("7000109744");
			bean.setLock("yes");
			bean.setConfirmPassword("nishil@123");
